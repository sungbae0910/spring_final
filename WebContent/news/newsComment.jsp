...
<body>
		...
		<c:set var="group" value="${i.cGroup}"/>
			...
			<input type="text" value="${i.cSerial}" class="serial${ii.index}">
				...
				<div class="single-comment justify-content-between d-flex">
					<div class="user justify-content-between d-flex">
						<div class="desc">
							...
							<div class="d-flex justify-content-between">
								<c:forEach begin="${ii.index}" end="${ii.index}" items="${cnt}" var="cn">
					...
					<div class="test_s">
						<div class="dropdown img_cmt2">
							...
							<div class="dropdown-menu" style="min-width: 5rem" aria-labelledby="dropdownMenuLink">
								<a class="dropdown-item" href="#" onclick="news_comment_delete('${ii.index}')">삭제</a>
							</div>
						</div>									
						<div>
							<br />
			...
			<div class="hide_comment${index} hide_come">
				<div class="comment-list2">
					...
					<input type="text" value="${re.cSerial}" class="sserial${ri.index}">
					<div class="single-comment justify-content-between d-flex">
						<div class="user justify-content-between d-flex">
							<div class="desc">
								<div class="d-flex justify-content-between">
